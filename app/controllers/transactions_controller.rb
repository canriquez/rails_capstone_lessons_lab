class TransactionsController < ApplicationController
  ...
  before_action :authors_only, only: [ :destroy, :confirm_destroy ]
    ...
    def authors_only
      ...
      puts "Current user role: #{current_user.role}, is authorised to destroy? : #{current_user == @transaction.teacher_id}"
      puts "Current user id: #{@transaction.teacher_id}, current_user.id :#{current_user.id}"
